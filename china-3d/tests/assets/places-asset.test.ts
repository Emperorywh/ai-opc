 ...
 * scripts/places 34 省 × 2 角色领域真值与 src/geo-contracts 契约层。直接读取 public/geo 下
 * 已交付的生产地点目录资产（china-places.json + provenance）与省级目录 / 几何，证明
 * 34 省 × (1 锚点 + 1 行政中心) / 港澳台 / 真值一致 / 坐标范围 / 点落入对应省域 / 来源审计
 * 全部成立；并验证缺失省会、重复关联、越界坐标、未知行政区、点落省域外等篡改路径被确定性发现。
 *
