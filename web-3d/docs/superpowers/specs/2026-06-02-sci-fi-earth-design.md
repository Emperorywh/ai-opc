...
| @reduxjs/toolkit + react-redux | 状态管理（相机状态、输入模式、加载进度） |
...
├── stores/
│   ├── sceneSlice.ts                # Redux Toolkit 地球/场景状态 slice
│   ├── cameraSlice.ts               # Redux Toolkit 相机状态 slice
│   ├── inputSlice.ts                # Redux Toolkit 输入模式状态 slice
│   ├── loadingSlice.ts              # Redux Toolkit 加载状态 slice
│   └── store.ts                     # Redux Toolkit store 配置
├── utils/
